    ...
    <div>
        ...
        <div className="md:min-h-screen flex">
          <div className="lg:flex gap-20 max-w-7xl m-auto">
            <div className="basis-5/12 my-20 lg:my-32">
              ...
              <button className="btn btn-lg btn-outline rounded-full"><Link to="/courses-list">Explore Courses</Link></button>
            </div>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg">
                <h2 className="text-base leading-7 text-black">Unlocking Advantages.</h2>
                <h1 className="mt-2 text-4xl lg:text-6xl font-bold text-gray-900 sm:text-4xl">Benefits</h1>
                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                  <div className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900">
                      <svg className="absolute left-1 top-1 h-5 w-5 text-black" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    ...
                    <dd className="inline"> Drastically reduces manual tasks, paperwork, and administrative efforts in the course registration process, leading to streamlined operations for both students and administrators</dd>
                  </div>
                  <div className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900">
                      <svg className="absolute left-1 top-1 h-5 w-5 text-black" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    ...
                    <dd className="inline"> Ensures a positive and user-friendly interface, making it easy for students to navigate and engage with the system. Administrators also benefit from a smoother workflow, improving overall user satisfaction</dd>
                  </div>
                  <div className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900">
                      <svg className="absolute left-1 top-1 h-5 w-5 text-black" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    ...
                    <dd className="inline">   Empowers administrators with insightful analytics, aiding in strategic decision-making. The system's data-driven approach allows for better planning, adapting to changing academic needs, and maintaining competitiveness in the educational landscape.
                    </dd>
                  </div>
                </dl>
              </div>
            </div>
            <img src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Product screenshot" className="w-[48rem] max-w-none rounded-l-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0" width="2432" height="1442" />
          </div>
        </div>
      </div>
        ...
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          <li>
            <div className="timeline-middle">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-5 w-5"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" /></svg>
            </div>
      ...
      <div className="px-8 lg:px-32">
        <div className="bg-white p-4 rounded-lg shadow-xl py-8 mt-12">
          <h1 className="text-4xl font-bold text-gray-800 tracking-widest uppercase text-center">FAQ</h1>
          ...
          <div className="space-y-12 px-2 xl:px-16 mt-12">
            <div className="mt-4 flex">
              ...
              <div>
                <div className="flex items-center h-16">
                  <span className="text-lg text-black font-bold">Lorem ipsum dolor sit amet?</span>
                </div>
            ...
            <div className="mt-4 flex">
              ...
              <div>
                <div className="flex items-center h-16">
                  <span className="text-lg text-black font-bold">Consectetur adipisicing elit?</span>
                </div>
                <div className="flex items-center py-2">
                  <span className="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, dignissimos. Neque eos, dignissimos provident reiciendis debitis repudiandae commodi perferendis et itaque, similique fugiat cumque impedit iusto vitae dolorum. Nostrum, fugit!</span>
            ...
            <div className="mt-4 flex">
              ...
              <div>
                <div className="flex items-center h-16">
                  <span className="text-lg text-black font-bold">Neque eos, dignissimos provident reiciendis debitis?</span>
                </div>
                <div className="flex items-center py-2">
                  <span className="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, dignissimos. Neque eos, dignissimos provident reiciendis debitis repudiandae commodi perferendis et itaque, similique fugiat cumque impedit iusto vitae dolorum. Nostrum, fugit!</span>
            ...
            <div className="mt-4 flex">
              ...
              <div>
                <div className="flex items-center h-16">
                  <span className="text-lg text-black font-bold">Repudiandae commodi perferendis et itaque?</span>
                </div>
                <div className="flex items-center py-2">
                  <span className="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, dignissimos. Neque eos, dignissimos provident reiciendis debitis repudiandae commodi perferendis et itaque, similique fugiat cumque impedit iusto vitae dolorum. Nostrum, fugit!</span>
            ...
            <div className="mt-4 flex">
              ...
              <div>
                <div className="flex items-center h-16">
                  <span className="text-lg text-black font-bold">Similique fugiat cumque?</span>
                </div>
                <div className="flex items-center py-2">
                  <span className="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, dignissimos. Neque eos, dignissimos provident reiciendis debitis repudiandae commodi perferendis et itaque, similique fugiat cumque impedit iusto vitae dolorum. Nostrum, fugit!</span>
            ...
            <div className="mt-4 flex">
              ...
              <div>
                <div className="flex items-center h-16">
                  <span className="text-lg text-black font-bold">Impedit iusto vitae dolorum, nostrum fugit?</span>
                </div>
                <div className="flex items-center py-2">
                  <span className="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, dignissimos. Neque eos, dignissimos provident reiciendis debitis repudiandae commodi perferendis et itaque, similique fugiat cumque impedit iusto vitae dolorum. Nostrum, fugit!</span>
                </div>
