      ...
      <div className="px-8 lg:px-32 bg-base-200">
        <div className="hero min-h-screen flex flex-row">
          <div className="hero-content flex-col lg:flex-row-reverse mb-28">
            <div className="rounded-md  shadow-2xl basis-7/12" >
              <img src="https://images.unsplash.com/photo-1602734666440-b57ff6b304bd?q=80&w=2669&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="hero image" />
            </div>
